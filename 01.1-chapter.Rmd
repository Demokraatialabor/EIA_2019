...
<p class="caption" id="figure112"><span class="figure-number">Joonis 1.1.2.</span> Uute elamualade lisandumine (liigu kaardil, et näha täpsemalt)</p>
...
```{r, figure112a, out.width='100%', fig.align='center', echo=FALSE, message=FALSE}

#knitr::include_graphics("figures/1-chapter/fig112.png")
