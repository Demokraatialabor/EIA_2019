...
```{block, type='blockquote-right'}
Keskkonna otsuste vaided ei ole tõhusad, kuna vaideid lahendavad sageli samad asutused, kes tegid vaidlustatava otsuse.
```
