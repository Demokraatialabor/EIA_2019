...
<div><a class="print-btn EE-btn" href="en/public-participation-in-decisions-on-the-use-of-natural-areas.html">EN</a></div>
...
```{r, figure344, out.width="90%", fig.asp=1.5, message=FALSE, echo=FALSE, warning=FALSE}
...
fig344_data$variable <- factor(fig344_data$variable, levels = c("Isikuid","Vaatusi","Linnuvaatlejate arv","Linnuvaatluste arv"))
  ...
  fig344_plot <- ggplot() +
    geom_line(data = fig344_data, mapping = aes(x=year, y=as.numeric(value), group=variable, colour=variable, text = paste("", year,
                         "<br>", value)), size=0.75) +
    labs(y="", x="") +
    expand_limits (y=0) +
...
### Kokkuvõte {-.chapter3_section #kokkuvõte-34}
...
### Viidatud allikad {-.subreferences #viidatud-allikad-34}
