...
```{block, type='authors'}
**[Age Poom](#age-poom) ja [Kalev Sepp](#kalev-sepp)**
```
...
```
``` {block, type='figure-comment'}
<span class="figure-comment-start">Märkus:</span> Ala metsas, kus kitsalt kohastunud, ohustatud, ohualdiste või haruldaste liikide esinemise tõenäosus on suur. Vääriselupaik on erametsas kaitstud vabatahtlikult, riigimetsas Keskkonnaministri käskkirja alusel.
```
