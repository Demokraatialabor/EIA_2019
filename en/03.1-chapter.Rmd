...
```{r, figure312, out.width='100%', fig.align='center', echo=FALSE, message=FALSE}
...
fig312_plot_palette <- c("#b8ddea","#44a1b1","#388085","#8d76ad","#79AC2C","#5B8121","#482683","#2E4111")
  ...
  fig312_plot2 <- ggplot(data = fig312_data2) +
    geom_bar(mapping = aes(x=park, y=visitors, fill=year, text = paste("", park,
                         "<br>", year,
...
<div class=desktop-plot>
```{r, figure313, out.width='100%',fig.asp=1.25, fig.align='center', echo=FALSE, message=FALSE}
...
fig313_data_melt$variable <- factor(fig313_data_melt$variable, levels = c("Tallinna pargikülastajad","Jahimehed","Marjulised-seenelised","Välisturistid 2015","Looduspuhkus 2015","Looduspuhkus 2010"))
  ...
  fig313_plot <- ggplot(data = fig313_data_melt) +
    geom_bar(mapping = aes(x=vanus, y=value, fill=variable, text = paste("", vanus,
                         "<br>", variable,
...
<p id="Jõks2017">Jõks, K. 2017. Eesti vaatetornid, nende seisund ning potentsiaalsed uute vaatetornide asukohad. BA thesis. Eesti Maaülikool.</p>
...
<p id="2indicators2018">Sustainable Development Indicators – Säästva arengu näitajad 2018. Tallinn: Statistikaamet.</p>
