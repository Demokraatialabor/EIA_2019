...
<p class="caption" id="figure113"><span class="figure-number">Joonis 1.1.3.</span> Changes in population density in Tartu between two censuses (2000 and 2011) show homogenised intensity of the use of space in the city and its hinterland</p>
...
```
``` {block, type='imgsource'}
<div><span class="imgsource-source">Source:</span> Statistics Estonia, 2008 and 2011 population censuses.</div>
...
```{block, type='imgsource'}
<div><span class="imgsource-source">Source:</span> Statistikaamet.</div>
...
<p class="caption" id="figure144"><span class="figure-number">Joonis 1.4.4.</span> People’s assessment of the condition of their housing based on the age (top) and type (bottom) of the residential building</p>
<div class="desktop-plot">
...
<p class="caption" id="figure148"><span class="figure-number">Joonis 1.4.8.</span> People’s assessment of the condition of their dwellings by income and settlement type (left: 20% of the population with the lowest income; right: 20% of the population with the highest income; ‘regional centres’ refers to county towns)</p>
<div class="desktop-plot">
...
<div><a class="print-btn" href="../print/EIA-2019-1.5.pdf"><i class="fa fa-file" aria-hidden="true"></i>Print</a></div>
```
...
## Introduction {-.chapter_section .chapter3_section .intro_section}
...
<p class="caption" id="figure301"><span class="figure-number">Joonis 3.0.1.</span> The correlation between the Human Development Index and the Ecosystem Vitality Index based on 179 countries and the change in Estonia’s position (green dots, years) 2005–2014</p>
...
<p class="caption" id="figure315"><span class="figure-number">Joonis 3.1.5.</span> Recreational fishermen at Vahejärve Lake, Otepää, 1945</p>
...
<p class="caption" id="figure336"><span class="figure-number">Joonis 3.3.6.</span> Interruptions in the green network of Harjumaa in 2012 compared to 2006</p>
...
<p class="caption" id="figure344"><span class="figure-number">Joonis 3.4.4.</span> General usage data for the Estonian Nature Observations Database (A1, A2) and the use of the University of Tartu Natural History Museum’s PlutoF database by birdwatchers (B1, B2) over a period of nine years</p>
...
## Introduction {-.chapter_section .chapter4_section .intro_section}
...
## Introduction {-.chapter_section .chapter5_section .intro_section}
