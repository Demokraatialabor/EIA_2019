# Autorid ja toimetajad {.chapter6 .chapter6_section}

### Peatoimetaja {-.chapter_section .chapter6_section .intro_section}

<div class="author-container">

<div>
```{r, out.width='50%', fig.align='left'}
knitr::include_graphics('figures/6-authors/HelenSooväli-Sepping.png')
```
</div>
...
### Peatüki toimetajad {-.chapter_section .chapter6_section}

<div class="author-container">

<div>
```{r, out.width='50%', fig.align='left'}
knitr::include_graphics('figures/6-authors/KristiGrišakov.png')
```
</div>
...
<div>
```{r, out.width='50%', fig.align='left'}
knitr::include_graphics('figures/6-authors/AskoLõhmus.png')
```
</div>
...
### Autorid {-.chapter_section .chapter6_section}
...
<div>
```{r, out.width='50%', fig.align='left'}
knitr::include_graphics('figures/6-authors/RagneKõuts-Klemm.png')
```
</div>
...
<div>
```{r, out.width='50%', fig.align='left'}
knitr::include_graphics('figures/6-authors/AnneliKährik.png')
```
</div>
...
<div>
```{r, out.width='50%', fig.align='left'}
knitr::include_graphics('figures/6-authors/TõnuOja.png')
```
</div>
...
<div>
```{r, out.width='50%', fig.align='left'}
knitr::include_graphics('figures/6-authors/BiankaPlüschke-Altof.png')
```
</div>
...
<div>
```{r, out.width='50%', fig.align='left'}
knitr::include_graphics('figures/6-authors/KärtVaarmari.png')
```
</div>
...
<div>
```{r, out.width='50%', fig.align='left'}
knitr::include_graphics('figures/6-authors/AnnikaVäiko.png')
```
</div>
