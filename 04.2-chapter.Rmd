...
ggsave(path="exported_figures/PDF",filename="fig421.pdf", height=200, width=200, units="mm")
...
<p class="caption" id="figure422"><span class="figure-number">Joonis 4.2.2.</span> Laste digitaalse kaasatuse redeli astmed 2010 ja 2018 (online-tegevust harrastavate laste %)</p>
...
```{r, figure422, out.width='80%', fig.asp=.75, fig.align='center', echo=FALSE, message=FALSE}
...
ggsave(path="exported_figures/PDF",filename="fig423.pdf", height=230, width=170, units="mm")
...
```{r, figure424, out.width='80%', fig.asp=.75, fig.align='center', echo=FALSE, message=FALSE}
