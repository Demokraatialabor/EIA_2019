...
```{r, joonis231, fig.cap='Location of workplace in county of residence, elsewhere in Estonia and outside Estonia among the residents of Viljandi, Valga, Võru and Põlva county', out.width='80%', fig.asp=.75, fig.align='center', echo=FALSE, message=FALSE}
library("tidyverse")
```
