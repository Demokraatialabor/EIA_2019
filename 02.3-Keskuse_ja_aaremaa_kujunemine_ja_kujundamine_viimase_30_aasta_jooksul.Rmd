...
### Rahvastiku vähenemise ja ääremaastumise tsükkel taastoodab iseennast {.chapter2_section}
...
```{r, joonis231, fig.cap=' Eesti regionaalne polariseerumine: rahvastikumuutused ja SKP jaotumine 1995. ja 2016. aastal.', out.width='80%', fig.asp=.75, fig.align='center', echo=FALSE, message=FALSE}
...
```{r, joonis232, fig.cap='Viljandi-, Valga-, Võru- ja Põlvamaa elanike töökohtade paiknemine elukoha maakonnas, mujal Eestis või väljaspool Eestit 2000. ja 2011.aastal', out.width='80%', fig.asp=.75, fig.align='center', echo=FALSE, message=FALSE}

 library("tidyverse")
library("svglite")

  fig2 <- read.csv ("data/23_fig2_data.csv", header=TRUE, fileEncoding="utf-8")
 ...
 fig2theme <- theme(
  ...
  ggsave(path="exported_figures/SVG/", filename="fig232.svg", height=150, width=200, units="mm")
  ggsave(path="exported_figures/PDF",filename="fig232.pdf", height=150, width=200, units="mm")
  ggsave(path="exported_figures/PNG",filename="fig232.png",height=150, width=200, units="mm")
```
```{block, type='imgsource'}
Allikas: Statistikaamet
```
...
### Maapiirkondade ja väikelinnade häbimärgistamine süvendab veelgi nende ääremaastumist {.chapter2_section}
...
```{r, joonis233, fig.cap='Kes kujundavad maapiirkondade kuvandit Eesti trükimeedias?', out.width='80%', fig.asp=.75, fig.align='center', echo=FALSE, message=FALSE}
...
```{r, joonis234, fig.cap='Mis kohti kirjeldatakse Eesti trükimeedias kui ääremaad?', out.width='80%', fig.asp=.75, fig.align='center', echo=FALSE, message=FALSE}
library(ggwordcloud)
library(dplyr)
...
### Konkurentsivõimel põhinev regionaalpoliitika ei ole piirkondade polariseerumist vähendanud {.chapter2_section}
...
### Ääremaa-staatus ja -kuvand piiravad koha konkurentsivõimet {.chapter2_section}
...
### Regionaalpoliitika edendamine objektiivse ja subjektiivse ääremaastumisega võitlemise teel {.chapter2_section}
