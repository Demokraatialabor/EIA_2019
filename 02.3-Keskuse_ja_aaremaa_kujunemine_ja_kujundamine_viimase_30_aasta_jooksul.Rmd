## Keskuse ja ääremaa kujunemine ja kujundamine viimase 30 aasta jooksul {#chapter23}
...
```{r, joonis232, fig.cap='Viljandi-, Valga-, Võru- ja Põlvamaa elanike töökohtade paiknemine elukoha maakonnas, mujal Eestis või väljaspool Eestit 2000. ja 2011.aastal', out.width='80%', fig.asp=.75, fig.align='center', echo=FALSE, message=FALSE}
 ...
 library("tidyverse")
  ...
  geom_col(mapping = aes(x=county, y=value), fill="#482683") +
  facet_wrap(~location_est, nrow=1) +
  labs(y="tööjõu arv", x="maakonnad")
  
 fig2theme <- theme(
                    text = element_text(color = "#777777", size = 15),
