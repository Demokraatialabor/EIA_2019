...
<div><a class="print-btn EE-btn" href="en/the-role-and-status-of-experts-in-societal-media-discussions.html">EN</a></div>
...
```{r, figure442, out.width='90%', fig.asp=.5625, fig.align='center', echo=FALSE, message=FALSE}
...
names(fig442_data_cleaned)[names(fig442_data_cleaned) == "Freq"] <- "Sagedus"

  fig442_plot <- ggplot(data = fig442_data_cleaned) +
    geom_line(mapping = aes(x=date, y=Sagedus),group="date", size=.75, colour="#BC9417") +
...
ggplotly(fig442_plot + fig_theme_general + fig442_theme, tooltip = "Sagedus") %>%
...
### Kokkuvõte {-.chapter4_section #kokkuvõte-44}
...
### Viidatud allikad {-.subreferences #viidatud-allikad-44}
...
<p id="Saarts2018">Saarts, T. 2018. Hüvasti, postkommunistlik Eesti! – Sirp, 14.12.2018.</p>
