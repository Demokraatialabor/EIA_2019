...
<p class="caption" id="figure443"><span class="figure-number">Joonis 4.4.3.</span> rafineerimistehase meeleavaldus Emajõel, Tartus</p>

```{block, type='imgsource'}
<span class="imgsource-source">Allikas:</span> Foto autor Oop.
```
