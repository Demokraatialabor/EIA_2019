...
<p class="caption" id="figure315"><span class="figure-number">Joonis 3.1.5.</span> Harrastuskalamehed Vahejärvel, Otepääl, aastal 1945</p>

```{r, figure315, fig.asp=.75, fig.align='center', echo=FALSE, message=FALSE, warning=FALSE}
```
...
Marjuliste ruumikäitumist uuriti 2017. aastal, küsitledes mustikakorjajaid, kelle seas valdasid Lõuna-Eestis nii oma tarbeks kui ka müügiks korjajad ([Remm jt 2018](#Remm2018)). Uuringust ilmnes kolm asjaolu, mis näitavad, et suhtlusest kohaliku kogukonnaga ei piisa marjametsi säästvate planeeringute tegemiseks.
...
```
```{block, type='imgsource'}
<span class="imgsource-source">Allikas:</span> foto autor Joonas Remm.
```
...
<p id="Järv2006">Järv, O., Silm, S., Ahas, R. 2006. Tallinna rohealade külastatavus ja külastajate hinnangud. Teemaplaneeringu „Tallinna rohealad” taustauuring. Tartu: Tartu Ülikool, Bioloogia-geograafiateaduskond, Geograafia instituut.</p>
...
<p id="Kaldaru2011">, H. 2011. Marjade ja seente korjamine elanikkonnas. Tallinn: Turu-uuringute AS.</p>
...
<p id="Peterson2010">Peterson, K. 2010. Elukvaliteedist ja keskkonnast. Keskkond ja avalik huvi. Rohealade väärtus linnakeskkonnas. – Aaviksoo, A., Peterson, K., Noorkõiv, R., Vöörmann, R., Kalmus, V., Terk, E., Lauristin, M. (toim.). Eesti Inimarengu Aruanne 2009. Tallinn: AS Eesti Ajalehed, 26–34.</p>
...
<p id="Tuhkanen2018">Tuhkanen, H., Kuldna, P., Uustal, M. 2018. Linna ökosüsteemiteenused Tallinna näitel. NATTOURS.</p>
