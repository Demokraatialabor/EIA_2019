...
```{r, figure311, fig.align='center', out.width='80%', echo=FALSE, message=FALSE, warning=FALSE}
...
fig312_plot1_palette <- c("#2E4111","#482683","#5B8121","#79AC2C","#8d76ad","#388085","#44a1b1","#b8ddea")

  fig312_plot1 <- ggplot(data = fig312_data1) +
    geom_bar(mapping = aes(x=year, y=visitors), fill=fig312_plot1_palette, width=0.7, stat="identity", position="dodge") +
  ...
  fig312_plot2 <- ggplot(data = fig312_data2) +
    ...
    scale_fill_manual(values=c("#2E4111","#482683","#5B8121","#79AC2C","#8d76ad","#388085","#44a1b1","#b8ddea")) +
