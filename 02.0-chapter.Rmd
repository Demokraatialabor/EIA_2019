...
```{block, type='points'}
* Eestis on avaliku ruumi loome olnud süsteemitu ja killustunud erineva fookusega planeeringute vahel.

* Valdkondi siduva ruumiloome abil on võimalik püüelda suuremate probleemide lahendamise suunas.

* Koosloome asemel on avaliku ruumi planeerimine Eesti linnades olnud pigem menetlusprotsessile keskenduv ja formaalselt kaasav kui erinevatele teadmistele ja andmetele tuginev protsess.
```
